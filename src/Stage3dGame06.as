...
// The mesh data
		[Embed(source="art/cluster.obj", mimeType="application/octet-stream")]
		...
		[Embed(source="art/box.obj", mimeType="application/octet-stream")]
...
// The terrain mesh data
		...
		private function initData():void
		{
			...
			myMesh1=new Stage3dObjParser(myObjData1, context3D, 1, true, true);
			myMesh2=new Stage3dObjParser(myObjData2, context3D, 1, true, true);
			myMesh3=new Stage3dObjParser(myObjData3, context3D, 1, true, true);
			myMesh4=new Stage3dObjParser(myObjData4, context3D, 1, true, true);
			myMesh5=new Stage3dObjParser(myObjData5, context3D, 1, true, true);
