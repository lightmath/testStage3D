...
package
{
	...
	public class Stage3dGame07 extends Sprite
	{
		...
		* comment out the following: */
		...
		[Embed(source="art/sphere.obj", mimeType="application/octet-stream")]
		...
		private function initData():void
		{
			...
			particleSystem.defineParticle("explosion", new Stage3dParticle(explosion1_data, context3D, puffTexture, explosion2_data));
